...
echo_and_run cd "/home/matija-kk/projekt/src/vision_opencv/image_geometry"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python" \
    "/home/matija-kk/projekt/src/vision_opencv/image_geometry/setup.py" \
    build --build-base "/home/matija-kk/projekt/build/vision_opencv/image_geometry" \
    install \
    $DESTDIR_ARG \
